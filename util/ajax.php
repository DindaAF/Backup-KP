	...
	if(isset($_POST['atestasi'])){
		...
		$response .= '  
			<h1>Detail Atestasi</h1>
                ...
                <tr>  
					<td width="25%"><b>Nomor Atestasi</b></td>
					<td width="25%">'.$results->getNoAtestasi().'</td>
					<td width="25%"><b>Nama Lengkap</b></td>
					<td width="25%">'.$results->getNamaLengkap().'</td>
				</tr>
				<tr>
					<td width="25%"><b>Tanggal Pengajuan</b></td>
					<td width="25%">'.date_format(date_create($results->getTglPengajuan()), 'd-M-Y').'</td>
					<td width="25%"><b>Email</b></td>
					<td width="25%">'.$results->getEmail().'</td>
				</tr>
				<tr>
					<td width="25%"><b>No Telp</b> </td>
					<td width="25%">'.$results->getNoTelp().'</td>
					<td width="25%"><b>No Whatsapp</b></td>
					<td width="25%">'.$results->getNoWA().'</td>
				</tr>
				<tr>
					<td width="25%"><b>Alamat</b></td>
					<td width="25%">'.$results->getAlamat().'</td>
					<td width="25%"><b>Gereja Asal</b></td>
					<td width="25%">'.$results->getGerejaAsal().'</td>
				</tr>
				<tr>
					<td width="25%"><b>Agama</b></td>
					<td width="25%">'.$results->getAgama().'</td>
					<td width="25%"><b>Scan Akte Baptis/Sidi</b></td>
					<td width="25%"><img id="myImg2" src = '.$results->getScanAkteBaptisSidi().' height=20% width=20%></td>
				</tr>
				<tr>
					<td width="25%"><b>Pas Foto</b></td>
					<td width="25%"><img id="myImg" src = '.$results->getPasFoto().' height=20% width=20%></td>
					<td width="25%"><b>Surat Keterangan</b> </td>
					<td width="25%"> <img id="myImg3" src = '.$results->getSuratKeterangan().' height=20% width=20%></td>
				</tr>
				<tr>
